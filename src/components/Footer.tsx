    ...
    <footer className="bg-luxury-black text-white pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
        <div className="space-y-6">
          <h3 className="text-2xl font-serif tracking-widest">VELUXE</h3>
          <p className="text-gray-400 text-sm font-light leading-relaxed">
            Elevating everyday essentials into extraordinary experiences. Veluxe represents the pinnacle of craftsmanship and timeless elegance.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm text-gray-400 font-light">
            <li className="flex items-start space-x-3">
              ...
              <span>123 Luxury Avenue, Gulshan 2, Dhaka, Bangladesh</span>
            </li>
            ...
            <li className="flex items-center space-x-3">
              ...
              <span>concierge@veluxe.com</span>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 text-[10px] uppercase tracking-[0.2em] text-gray-500">
        <p>© 2026 VELUXE LUXURY RETAIL. ALL RIGHTS RESERVED.</p>
